...
<html>
	<head>
    	<script type="text/javascript">
			...
			{
				var name = document.samsung.name;
				var price = document.samsung.price;
				if( name.value == "" )
				{
    ...
    <body>
        ...
        <table>
        	<form name="samsung" action="bid.php" method="POST" onsubmit="return(checkDetails());">
            	<tr>
                ...
                <tr>
                	<th>Brand : </th>
                    <td><input type="text" name="brand" value="samsung" onKeyPress="noChange()"></td>
                </tr>
                <tr>
