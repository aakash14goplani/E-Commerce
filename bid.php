<?php
	...
	{
		$brandname = $_SESSION['brandname'] = $_POST['brand'];
		$productname = $_SESSION['productname']  = $_POST['name'];
		...
		{						
			function bid()
			{
				...
				$query = mysql_query("INSERT INTO bid VALUES ('$username', $brandvalue)");
				$query = mysql_query("INSERT INTO bid VALUES ('user1', $user1)");
				$query = mysql_query("INSERT INTO bid VALUES ('user2', $user2)");
				$query = mysql_query("INSERT INTO bid VALUES ('user3', $user3)");
				$query = mysql_query("INSERT INTO bid VALUES ('user4', $user4)");
				...
				echo "
					...
					<head>
						...
						<body>
							<table>
								<form name='bid' action='bid2.php' method='POST' onsubmit='return(checkDetails());'>
									<tr>
