...
<html>
	<head>
    	<script type="text/javascript">
			...
			{
				var name = document.windows.name;
				var price = document.windows.price;
				if( name.value == "" )
				{
    ...
    <body>
        ...
        <table>
        	<form name="windows" action="bid.php" method="POST" onsubmit="return(checkDetails());">
            	<tr>
                ...
                <tr>
                	<th>Brand : </th>
                    <td><input type="text" name="brand" value="windows" onKeyPress="noChange()"></td>
                </tr>
                <tr>
